"""
Notification tasks module for the Molecular Data Management and CRO Integration Platform.

This module implements Celery tasks for asynchronous notification processing including
delivery of notifications to users about various system events such as experiment status changes,
CRO submissions, quotes, and result uploads. It also provides tasks for notification management
like marking notifications as read and cleaning up old notifications.
"""
